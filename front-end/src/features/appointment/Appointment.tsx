...
const Appointment = () => {
    ...
    const handleSubmit = async (event: any) => {
      ...
      dispatch(postAppointmentAsync(appointmentData));
        ...
        <Row>
          <Col md={6}>
            ...
            <Form.Group controlId="formMessage">
              <Form.Label>הודעה (לא חובה)</Form.Label>
              <Form.Control
                as="textarea"
                value={message}
            ...
            <br />
            <Button style = {{boxShadow: '0 7px 10px 0 rgba(0, 0, 0, 0.6), 0 1px 20px 0 rgba(0, 0, 0, 0.20)'}} disabled={!savedDate} variant="success" type="submit">
              שלח פרטים
            </Button>
          </Col>
        </Row>
